...
class at.klickverbot.event.MixinDispatcher extends EventDispatcher {
   public function overwriteMethods( target :Object ) :Void {
      ...
      target[ 'addUnhandledEventsListener' ] = Delegate.create( this, addUnhandledEventsListener );
      target[ 'removeUnhandledEventsListener' ] = Delegate.create( this, removeUnhandledEventsListener );
